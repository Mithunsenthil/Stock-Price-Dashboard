...
# List of major Nifty 50 companies ticker symbols
nifty_50_tickers = [
    'RELIANCE.NS', 'TCS.NS', 'HDFCBANK.NS', 'INFY.NS', 'ICICIBANK.NS', 'HDFC.NS', 
    'BHARTIARTL.NS', 'KOTAKBANK.NS', 'ITC.NS', 'LT.NS', 'AXISBANK.NS', 'MARUTI.NS',
    'M&M.NS', 'NTPC.NS', 'ULTRACEMCO.NS', 'POWERGRID.NS', 'SUNPHARMA.NS', 'BAJAJ-AUTO.NS',
    'WIPRO.NS', 'HINDUNILVR.NS', 'SBIN.NS', 'TITAN.NS', 'HCLTECH.NS', 'BAJAJFINSV.NS',
    'ASIANPAINT.NS', 'HDFCLIFE.NS', 'SHREECEM.NS', 'BAJAJFINANCE.NS', 'CIPLA.NS',
    'DRREDDY.NS', 'NESTLEIND.NS', 'ADANIGREEN.NS', 'INDUSINDBK.NS', 'GRASIM.NS',
    'DIVISLAB.NS', 'M&MFIN.NS', 'EICHERMOT.NS', 'UPL.NS', 'TATAMOTORS.NS', 'JSWSTEEL.NS',
    'TECHM.NS', 'TATACONSUM.NS', 'APOLLOHOSP.NS', 'COALINDIA.NS', 'ONGC.NS', 'HINDALCO.NS'
]
